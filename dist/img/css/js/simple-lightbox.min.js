...
var SimpleLightbox = function () {
  function n(t, e) {
    ...
    _classCallCheck(this, n),
      ...
      "string" == typeof t
        ? (this.t = t, this.elements = Array.from(document.querySelectorAll(t)))
        : this.elements = void 0 !== t.length && 0 < t.length
          ? Array.from(t)
          : [t],
        ...
        this.throttle(function (t) {
          ...
          i.g &&
            (t.preventDefault(),
              ...
              !i.h && -1 < ["ArrowLeft", "ArrowRight"].indexOf(t.key) &&
  ...
  return _createClass(n, [{
    ...
    value: function () {
      this.p.e = document.createElement("div"),
        ...
        this.p.c.innerHTML = '<button class="sl-prev">'.concat(
    ...
    value: function (t) {
      return !this.options.fileExt ||
        "pathname" in t &&
          new RegExp("(" + this.options.fileExt + ")$", "i").test(t.pathname);
    },
  }, {
    ...
    value: function () {
      ...
      for (
        var i in e.dispatchEvent(new Event("close.simplelightbox")),
          ...
          this.fadeOut(
            ...
            function () {
              t.options.disableScroll && t.toggleScrollbar("show"),
                t.options.htmlClass && "" !== t.options.htmlClass &&
    ...
    value: function (a) {
      ...
      t.setAttribute("src", this.n.getAttribute("src")),
        ...
        t.addEventListener("error", function (t) {
          r.relatedElements[r.nIndex].dispatchEvent(new Event("error." + r.o)),
            r.h = !1,
            r.g = !1,
        ...
        t.addEventListener("load", function (t) {
          ...
          var e = t.target.width, i = t.target.height;
          ...
          (s = "data" === r.options.captionType
            ...
            1 === a || -1 === a
              ...
              : (r.h = !1, r.setCaption(s, e)),
            r.options.additionalHtml && !r.p.i &&
    ...
    value: function (t, e, i) {
      this.n.style[this.b + "transform"] = "translate(" + t + "," + e +
        ") scale(" + i + ")";
    },
  }, {
    key: "minMax",
                  ...
                  return i.n.classList.add("sl-transition"),
                    i.v.i
                      ...
                      : (i.v.w = i.options.doubleTapZoom,
                        i.setZoomData(i.v.w, 0, 0),
                        i.zoomPanElement("0px", "0px", i.v.w),
                        i.p.g.style.opacity || "none" === i.p.g.style.display ||
                        i.fadeOut(i.p.g, 200),
                        i.v.i = !0),
                    setTimeout(function () {
              ...
              (i.v.L = t.touches.length,
                0 === i.v.L
                  ? (i.n && i.setZoomData(i.v.w, i.v.C, i.v.D),
                    ...
                    i.v.p = !1)
                  : 1 === i.v.L
                  ? (i.v.s = t.touches[0].clientX, i.v.t = t.touches[0].clientY)
                  : 1 < i.v.L && (i.v.x = null)), i.v.g
            ) {
              var e = !(i.v.g = !1);
              i.options.loop ||
              (0 === i.nIndex && i.v.a < 0 && (e = !1),
                i.nIndex >= i.relatedElements.length - 1 && 0 < i.v.a &&
                (e = !1)),
                ...
                i.options.swipeClose && 50 < Math.abs(i.v.b) &&
                Math.abs(i.v.a) < i.options.swipeTolerance && i.close();
            }
          },
        ),
    ...
    value: function (t) {
      ...
      return {
        height: i - parseFloat(e.borderBottomWidth) - s -
          parseFloat(e.paddingTop) - parseFloat(e.paddingBottom),
        width: n - parseFloat(e.borderLeftWidth) -
          parseFloat(e.borderRightWidth) - parseFloat(e.paddingLeft) -
    ...
    value: function (t, e) {
      var i = this;
      this.options.captions && t && "" !== t && void 0 !== t &&
        (this.hide(this.p.g),
    ...
    value: function (t, e) {
      ...
      this.p.h.style[this.b + "transform"] = "translateX(" + e + ")",
        this.p.h.style[this.b + "transition"] = this.b + "transform " + t +
          "s linear";
    },
  }, {
    key: "getRelated",
    ...
    value: function (t, e, i, n) {
      ...
      var s, o = _createForOfIteratorHelper(t);
      try {
        for (o.s(); !(s = o.n()).done;) {
          var a = s.value;
          a.namespaces || (a.namespaces = {});
          var r, l = _createForOfIteratorHelper(e);
          try {
            for (l.s(); !(r = l.n()).done;) {
              var h = r.value, v = n || !1;
    ...
    value: function (t, e) {
      t = this.wrap(t), e = this.wrap(e);
      var i, n = _createForOfIteratorHelper(t);
      try {
        for (n.s(); !(i = n.n()).done;) {
          var s, o = i.value, a = _createForOfIteratorHelper(e);
          try {
            for (a.s(); !(s = a.n()).done;) {
              var r = s.value;
    ...
    value: function (r, t, l) {
      var e, h = this, i = _createForOfIteratorHelper(r = this.wrap(r));
      try {
        for (i.s(); !(e = i.n()).done;)e.value.style.opacity = 1;
      } catch (t) {
        i.e(t);
      } finally {
        i.f();
      ...
      !function t() {
        ...
        if ((e -= v) < 0) {
          var i, n = _createForOfIteratorHelper(r);
          try {
            for (n.s(); !(i = n.n()).done;) {
              var s = i.value;
          ...
          try {
            for (a.s(); !(o = a.n()).done;) o.value.style.opacity = e;
          } catch (t) {
            a.e(t);
          } finally {
            a.f();
    ...
    value: function (a, t, r, e) {
      var i, l = this, n = _createForOfIteratorHelper(a = this.wrap(a));
      try {
        for (n.s(); !(i = n.n()).done;) {
          var s = i.value;
      ...
      !function t() {
        ...
        if ((e += v) > h) {
          var i, n = _createForOfIteratorHelper(a);
          try {
            for (n.s(); !(i = n.n()).done;)i.value.style.opacity = "";
          } catch (t) {
            n.e(t);
          } finally {
            n.f();
          ...
          var s, o = _createForOfIteratorHelper(a);
          try {
            for (o.s(); !(s = o.n()).done;) s.value.style.opacity = e;
          } catch (t) {
            o.e(t);
          } finally {
            o.f();
    ...
    key: "hide",
    value: function (t) {
      var e, i = _createForOfIteratorHelper(t = this.wrap(t));
      try {
        for (i.s(); !(e = i.n()).done;) {
          var n = e.value;
    ...
    key: "show",
    value: function (t, e) {
      var i, n = _createForOfIteratorHelper(t = this.wrap(t));
      try {
        for (n.s(); !(i = n.n()).done;) {
          var s = i.value;
    ...
    value: function (t, e) {
      t = this.wrap(t);
      var i, n = _createForOfIteratorHelper(this.elements);
      try {
        for (n.s(); !(i = n.n()).done;) {
          var s = i.value;
    ...
    value: function (t) {
      t = this.wrap(t);
      var e, i = _createForOfIteratorHelper(this.elements);
      try {
        for (i.s(); !(e = i.n()).done;) {
          var n, s = e.value, o = _createForOfIteratorHelper(t);
          try {
            for (o.s(); !(n = o.n()).done;) {
              var a = n.value;
